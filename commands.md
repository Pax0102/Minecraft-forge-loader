...
ele volta pra tela principal, exceto a opção de sair.
 ...
 [3] Limpar temporários
     - Esvazia as pastas /temp e /downloads (downloads pendentes de
       uma instalação/atualização que falhou no meio do caminho)
 ...
 [10] Alterar RAM alocada
     - Antes só dava pra escolher a RAM na primeira instalação (ou
       editando o config.json na mão). Agora dá pra trocar a qualquer
       momento pelo menu.
